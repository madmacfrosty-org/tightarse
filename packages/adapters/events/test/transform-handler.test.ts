...
import { handlerConfig, keyFromEvent, processObject, realDeps, type TransformHandlerDeps } from "../src/transform-handler.js";
import type { TransformResult } from "@tightarse/truelayer";
