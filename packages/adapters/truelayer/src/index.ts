...
// The wire shapes come from map.ts, which is where the provider's format is
// defined. The generator consumes them rather than redefining them.
export {
  generateHousehold,
  generatePending,
  type Household,
  type HouseholdOptions,
} from "./generate/household.js";
export * from "./generate/raw-world.js";
export * from "./map.js";
